  ...
  <div class="container">
    ...
    <div class="col-md-9 page-left-border">
      <div class="page-left-margin">
        ...
        <h2 class="h3" style="text-transform: uppercase; font-weight: 700">IFVCC Archive</h2>

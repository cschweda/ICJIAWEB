<cfcomponent hint="Outputs the CF JSON based on the cohort" output="false">
	...
	<cffunction 	name="GetCJdata" access="remote" returnformat="json" output="false">
		...
		<cfquery name="OutputData" datasource="IdocIspTool">
			...
			, A.TotMatchSID
			, A.PctMatchSID
			, A.AvgNumPrison3 as AvgNumPrison
			, A.AvgNumArrests3 as AvgNumArrests
			, A.AvgNumConv3 as AvgNumConv
			, A.AvgNumProb3 as AvgNumProb
			, A.TotAnyPrison3 as TotAnyPrison
			, A.TotAnyArrests3 as TotAnyArrests
			, A.TotAnyConv3 as TotAnyConv
			, A.TotAnyProb3 as TotAnyProb
			, A.TotEvents
			, A.TotPriorIncarBase
			, A.CSS_ID_Prep
